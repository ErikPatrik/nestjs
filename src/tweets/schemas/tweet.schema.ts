// AQUI MODELAMOS A COLEÇÃO DE TWEETS NO BANCO DE DADOS
...
// Agora, precisamos ver novos novos tweets que chegaram no banco de dados
// Quando 10 novos tweets chegarem
// Quero enviar um novo e-mail para uma lista de contato
